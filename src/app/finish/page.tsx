  ...
  return (
    <div className="p-4 md:p-8 space-y-6">
      <div className="hidden print:block text-center space-y-2 mb-8 border-b-2 border-black pb-4">
        ...
        <p className="text-sm font-bold">Sistem Manajemen Terpadu UMKM</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 print:hidden">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-muted-foreground text-sm">Arsip data yang telah dinyatakan SELESAI.</p>
          </div>
        </div>
                ...
                <TableBody>
                  {actors?.map((actor) => (
                    <TableRow key={actor.id} className="hover:bg-green-50/50 print:border-b">
                      <TableCell className="font-bold text-green-700 uppercase">{actor.fullName}</TableCell>
                      <TableCell>
                        <Badge className="bg-emerald-500 hover:bg-emerald-600 font-black text-[9px] uppercase">
                          SELESAI
                        </Badge>
                      </TableCell>
                        ...
                        <div className="flex justify-end gap-2">
                          <Dialog>
                            ...
                            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                              <DialogHeader>
                                <DialogTitle className="text-2xl font-black text-primary uppercase">Detail Lengkap Data Final</DialogTitle>
                              </DialogHeader>
                              <div className="grid grid-cols-1 gap-8 pt-4">
                                <section className="space-y-4">
                                  ...
                                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm bg-muted/30 p-4 rounded-xl border">
                                    {[
                                      { l: "Nama Lengkap", v: actor.fullName },
                                      { l: "NIK", v: actor.nik },
                                      { l: "Nomor KK", v: actor.noKK },
                                      { l: "Gender", v: actor.gender },
                                      { l: "Lahir", v: actor.pobDob },
                                      { l: "HP", v: actor.phone }
                                    ].map((x, i) => (
                                      <div key={i}>
                                        <p className="text-[10px] font-bold text-muted-foreground uppercase">{x.l}</p>
                                ...
                                <section className="space-y-4">
                                  ...
                                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm bg-muted/30 p-4 rounded-xl border">
                                    {[
                                      { l: "Alamat", v: actor.address },
                                      { l: "RT/RW", v: actor.rtRw },
                                      { l: "Kelurahan", v: actor.kelurahan },
                                      { l: "Kecamatan", v: actor.kecamatan }
                                    ].map((x, i) => (
                                      <div key={i}>
                                        <p className="text-[10px] font-bold text-muted-foreground uppercase">{x.l}</p>
                                        <p className="font-bold">{x.v}</p>
                                ...
                                <section className="space-y-4">
                                  ...
                                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm bg-muted/30 p-4 rounded-xl border">
                                    {[
                                      { l: "Nama Usaha", v: actor.businessName },
                                      { l: "Kategori", v: actor.businessCategory },
                                      { l: "Lokasi", v: actor.businessLocation },
                                      { l: "Koordinator", v: actor.coordinator }
                                    ].map((x, i) => (
                                      <div key={i}>
                                        <p className="text-[10px] font-bold text-muted-foreground uppercase">{x.l}</p>
                                        <p className="font-bold">{x.v}</p>
                                ...
                                <section className="space-y-4">
                                  <div className="flex items-center gap-2 text-primary font-black text-sm uppercase border-b pb-1">
                                    <History className="w-4 h-4" /> Informasi Audit
                                  </div>
