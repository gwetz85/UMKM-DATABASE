                                  ...
                                  <div className="grid gap-6 py-4">
                                    <section className="space-y-4">
                                      ...
                                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-muted/30 p-4 rounded-xl border border-muted">
                                        {[
                                          ...
                                          { label: "No HP / WA", value: viewingActor.phone },
                                        ...
                                        <div className="md:col-span-3 space-y-1 pt-2 border-t">
                                          ...
                                          <p className="text-xs font-bold text-foreground">{viewingActor.address || "-"}</p>
                                        </div>
                                      </div>
                                    </section>
                                    ...
                                    <section className="space-y-4">
                                      ...
                                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                        {[
                                          { label: "KTP", uri: viewingActor.ktpUri },
                                          { label: "KK", uri: viewingActor.kkUri },
                                          { label: "NIB", uri: viewingActor.nibUri },
                                          { label: "Foto Usaha", uri: viewingActor.photoUsahaUri },
                                        ].map((doc, idx) => (
                                    ...
                                    <section className="space-y-4">
                                      ...
                                      <div className="bg-blue-50/50 p-4 rounded-xl border border-blue-100/50 flex justify-between">
                                        <div className="space-y-1">
                                          ...
                                          <p className="text-sm font-black text-primary uppercase">{viewingActor.createdBy || "-"}</p>
                                        </div>
                                        <div className="space-y-1 text-right">
                                          <p className="text-[10px] font-bold text-muted-foreground uppercase">Waktu Input</p>
                                          <p className="text-sm font-bold text-slate-700">{viewingActor.createdAt ? new Date(viewingActor.createdAt).toLocaleString('id-ID') : "-"}</p>
                                        </div>
                                      </div>
                                    </section>
                                  </div>
                                    ...
                                    <div className="space-y-4 border-t pt-4">
                                      ...
                                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="space-y-2">
                                          ...
                                          <span className="sr-only">Pilih Kelurahan</span>
