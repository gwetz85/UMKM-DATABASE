  ...
  const fetchLocation = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      (err) => {
        ...
        if (err.code === err.PERMISSION_DENIED) errorMsg = "Izin akses lokasi ditolak. Pastikan GPS aktif dan browser diizinkan mengakses lokasi.";
        else if (err.code === err.POSITION_UNAVAILABLE) errorMsg = "Informasi lokasi tidak tersedia. Coba lagi.";
