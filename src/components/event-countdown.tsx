...
export function EventCountdown({ targetDate, startDate }: EventCountdownProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      ...
      <div className="flex items-center gap-1.5 md:gap-6 bg-white/40 dark:bg-slate-900/40 border border-white/40 dark:border-slate-800/40 px-3 py-1.5 md:px-12 md:py-8 rounded-2xl shadow-sm backdrop-blur-md mt-1">
      <div className="flex flex-col items-center">
        <span className="text-[10px] md:text-5xl font-black text-primary leading-none">{timeLeft.days}</span>
      ...
      <span className="text-primary font-black animate-pulse opacity-40 md:text-3xl">:</span>
      <div className="flex flex-col items-center">
        <span className="text-[10px] md:text-5xl font-black text-primary leading-none">{timeLeft.hours.toString().padStart(2, '0')}</span>
      ...
      <span className="text-primary font-black animate-pulse opacity-40 md:text-3xl">:</span>
      <div className="flex flex-col items-center">
        <span className="text-[10px] md:text-5xl font-black text-primary leading-none">{timeLeft.minutes.toString().padStart(2, '0')}</span>
      ...
      <span className="text-primary font-black animate-pulse opacity-40 md:text-3xl">:</span>
      <div className="flex flex-col items-center">
        <span className="text-[10px] md:text-5xl font-black text-primary leading-none">{timeLeft.seconds.toString().padStart(2, '0')}</span>
