...
export function EventCountdown({ targetDate, startDate }: EventCountdownProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      ...
      <div className="flex items-center gap-1.5 md:gap-4 bg-white/40 dark:bg-slate-900/40 border border-white/40 dark:border-slate-800/40 px-3 py-1.5 md:px-8 md:py-5 rounded-2xl shadow-sm backdrop-blur-md mt-1">
