          ...
          <div className="flex flex-1 min-h-0 w-full overflow-hidden relative">
            ...
            <main className={cn(
              ...
              <div key={pathname} className={cn(
                ...
                isCekDataPage ? "p-3 sm:p-6 md:p-8 min-h-full pb-24 md:pb-20 max-w-7xl mx-auto" :
                isPendaftaranPage ? "p-3 sm:p-6 md:p-8 min-h-full pb-24 md:pb-20 max-w-5xl mx-auto" :
                isRootPage ? "p-3 sm:p-4 md:p-8 flex-1 flex flex-col min-h-0 pb-24 md:pb-20 lg:pr-[360px]" : 
                "p-3 sm:p-4 md:p-8 min-h-full pb-24 md:pb-20 lg:pr-[360px]"
              )}>
                {children}
              </div>
            </main>
